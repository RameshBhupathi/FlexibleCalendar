  ...
  * set true disable current day selection*/
    ...
    * */
    ...
    private void init(AttributeSet attrs) {
        ...
        monthViewPager.setNumOfRows(showDatesOutsideMonth ? 6 :
                FlexibleCalendarHelper.getNumOfRowsForTheMonth(displayYear, displayMonth,
                        startDayOfTheWeek));

        monthViewPagerAdapter = new MonthViewPagerAdapter(context, displayYear, displayMonth,
                this,
...
*/
    ...
    /**
     * Get the range date selection enable flag
     *
     * @return true if range selection is enabled
     */
    public boolean isRangeSelectionEnable() {
        return FlexibleCalendarGridAdapter.isRangeSelected;
    }
