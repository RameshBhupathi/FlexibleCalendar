...
public class MonthViewPagerAdapter extends PagerAdapter {
    ...
    private FlexibleCalendarGridAdapter.MonthVacancyDayFetcher monthVacancyDayFetcher;
    ...
    private void initializeDateAdapters(int year, int month) {
        ...
        for (int i = 0; i < VIEWS_IN_PAGER - 1; i++) {
            dateAdapters.add(new FlexibleCalendarGridAdapter(context, year, month, showDatesOutsideMonth,
                    ...
                    , disableTodaySelection, enableRangeSelection));
            if (month == 11) {
                year++;
                month = 0;
            } else {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        adapter.setMonthVacDayFetcher(monthVacancyDayFetcher);
    ...
    public void setMonthVacancyDayFetcher(FlexibleCalendarGridAdapter.MonthVacancyDayFetcher monthVacancyDayFetcher) {
