...
public class FiniteFlexibleCalendarView extends LinearLayout implements
  ...
  /*  public interface CalendarView {
    ...
    private FinitePagerAdapter monthInfPagerAdapter;
     ...
     */
    private FiniteMonthViewPager monthViewPager;
  ...
  * set true disable current day selection*/
    ...
    * */
    ...
    public FiniteFlexibleCalendarView(Context context) {
        super(context);
        this.context = context;
    }

    public FiniteFlexibleCalendarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init(attrs);
    }

    public FiniteFlexibleCalendarView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        ...
        //setup month view
        monthViewPager = new FiniteMonthViewPager(context);
        ...
        monthInfPagerAdapter = new FinitePagerAdapter(monthViewPagerAdapter, MAX_VALUE);
    ...
    private class MonthChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            if (disableAutoDateSelection) {
                Log.d("userselectedItem", "" + userSelectedItem);
...
*/
    ...
    private void moveToPosition(int position) {
        ...
        monthViewPager.setCurrentItem(position, true);
    }
     ...
     *
     * @param enableRangeSelection set true enable Range Selection
     */
